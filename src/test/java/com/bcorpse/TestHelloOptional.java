...
public class TestHelloOptional
{
    ...
    public void collect_optional_values_test(){
        ...
        List<String> upperCasedWords = optionals.stream().map(o -> o.map(String::toUpperCase)).collect(CustomCollector.optionalToList());
    ...
    public void collect_optional_with_default_values_test(){
        ...
        List<String> upperCasedWords = optionals.stream().map(o -> o.map(String::toUpperCase)).collect(CustomCollector.optionalToList(defaultValue));
